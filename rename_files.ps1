...
###############################################################
# Pattern à supprimer au début des noms des fichiers
###############################################################

$pattern = GUI_TextBox "" "Chaîne de caractère à supprimer dans le début des noms des fichiers:" "29-08-154_FL_STEMS_"

# test if input is empty
if (!$pattern) {
    throw_error("La chaîne de caractères ne peut être vide.")
}
